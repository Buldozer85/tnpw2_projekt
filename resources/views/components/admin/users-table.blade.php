                ...
                <table class="min-w-full divide-y divide-gray-300">
                   ...
                   @foreach($data as $user)
                       <tr>
                           ...
                           <x-admin.table.td>{{ $user->role }}</x-admin.table.td>

                           <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0 space-y-4">
                               <a href="#" class="text-red-600 hover:text-red-900">Smazat<span class="sr-only">, {{ $user->full_name }}n</span></a>
